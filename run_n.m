...
L = [100 150 200]; %L = [125 125 125 125]; %dimentions of communities 
...
%Martrix
M=adjacent_matrix_generator_multi_r(L,p,q,s,k1,k2);
for i=1:k
    A{i}=M(:,:,i);
end
...
file_name = ['Artificial_results_noise_' num2str(p/q) '_' num2str(k1) '_' num2str(k2) '.csv'];
